...
const initPrice = parseInt(allDetails.price)
...
const name = allDetails.name;
const img = allDetails.img;
    return (
        <div>
            <div className="row py-5">
                ...
                <div style={{height:'72vh',width:'75%',margin:'0 auto',textAlign:'left'}}>
                    ...
                    <div className="d-flex align-items-center">
                        <h1 style={{width:'160px'}}>${(price).toFixed(2)}</h1>
                    ...
                    <button onClick={()=>addToCart(num,price,id,name,img)} style={{background:"rgb(255, 0, 106)"}} className="border me-3 px-4 mt-3 py-2 text-light rounded-pill" ><BsCartCheckFill className="fs-4 me-3"/>Add</button>
                    <button onClick={backtoPre} className="border px-4 me-3 mt-3 py-2 bg-warning text-dark rounded-pill" >Back to previous Page</button>
                    <button onClick={orderView} className="border px-4 mt-3 py-2 bg-success text-light rounded-pill" >View Order</button>
                </div>
                </div>
                <div className="col-md-6 p-2">
